    ...
    <header className="border-b border-border bg-[var(--color-parchment)]">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/settings"
            className="press hidden rounded-full border border-border bg-card px-4 py-2 text-sm font-medium text-foreground transition hover:bg-secondary sm:inline-flex"
          >
            Settings
          </Link>
          <FeedbackButton />
